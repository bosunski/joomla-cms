...
/**
 * Guest Model for the Hotel component
 *
 * @since 1.0
 */
class HotelModelGuest extends JModelAdmin
{
    /**
    ...
    * @since   1.0
    */
    public function getTable($type = 'Guests', $prefix = 'HotelTable', $config = array())
    {
