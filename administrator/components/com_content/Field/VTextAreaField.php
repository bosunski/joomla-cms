 ...
 * @since  3.8.0
 */
class VTextAreaField extends TextareaField
{
	/**
	 * The form field type.
	 *
	...
	{
		return '<textarea v-model="'.$this->getAttribute('vmodel').'" name="'.$this->name.'" id="'.$this->id.'" aria-describedby="'.$this->description.'" class="form-control">'.$this->value.'</textarea>';
	}
}
